...
<div class="thumbnail clickable" onclick="useFile('{{ $file_name }}')">
  <div class="square" id="{{ $file_name }}" data-url="{{ str_replace('http://dalenguyen.me', 'http://dalenguyen.me/public', $file['url']) }}">
    @if($thumb_src)
    <img src="{{ str_replace('http://dalenguyen.me', 'http://dalenguyen.me/public', $thumb_src) }}">
    @else
